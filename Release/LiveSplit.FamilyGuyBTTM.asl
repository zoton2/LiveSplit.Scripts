...
update
{
	...
	if (((old.timerPhase != current.timerPhase && old.timerPhase != TimerPhase.Paused) || vars.doResetStart) && current.timerPhase == TimerPhase.Running) {
...
start {return vars.doResetStart;}
reset {return vars.doResetStart;}
